...
class NicepayRequestor {
    ...
    public function operation($type) {
        ...
        }    else if ($type == "registerCustomerId") {
            $this->apiUrl = NICEPAY_FIX_REG_CUSTOMER_ID;
        }    else if ($type == "retrieveVaInfo") {
            $this->apiUrl = NICEPAY_FIX_RETRIEVE_VA_INFO;
        }    else if ($type == "listDepositVa") {
            $this->apiUrl = NICEPAY_FIX_LIST_DEPOSIT_VA;
        }    else if ($type == "listDepositCustomerId") {
            $this->apiUrl = NICEPAY_FIX_LIST_DEPOSIT_CUSTOMERID;
        }
    }
