            ...
            <!--<div class="form-group">
						...
						<div class="form-group">
							<label class="col-md-2 control-label no-padding-right" for="form-field-1">Image Table Premium</label>

							<div class="col-md-10">
								<?php if($this->request->data['Product']['pic_premium_table']!=null)  echo '<a class="image-popup-no-margins" href="'.$this->Html->url('/img/prod/'.$this->request->data['Product']['pic_premium_table']).'">'.$this->Html->image('prod/small_'.$this->request->data['Product']['pic_premium_table'],array('width'=>'50px','height'=>'50px')).'</a>'; else echo $this->Html->image("/img/prod/no_img.jpg",array('width'=>'50','height'=>'50'));?> 
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-md-2 control-label no-padding-right" for="form-field-1">Upload Image Table Premium</label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="col-md-2 control-label no-padding-right" for="form-field-1">Image Product</label>

							<div class="col-md-10">
								<?php if($this->request->data['Product']['picture']!=null)  echo '<a class="image-popup-no-margins" href="'.$this->Html->url('/img/prod/'.$this->request->data['Product']['picture']).'">'.$this->Html->image('prod/small_'.$this->request->data['Product']['picture'],array('width'=>'50px','height'=>'50px')).'</a>'; else echo $this->Html->image("/img/prod/no_img.jpg",array('width'=>'50','height'=>'50'));?> 
							</div>
						</div>
