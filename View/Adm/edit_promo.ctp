...
<div class="row">
    ...
    <div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-1"><?php if($this->request->data['Promo']['img_promo_bilboard']!=null)  echo '<a class="image-popup-no-margins" href="'.$this->Html->url('/img/prom/'.$this->request->data['Promo']['img_promo_bilboard']).'">'.$this->Html->image('prom/'.$this->request->data['Promo']['img_promo_bilboard'],array('width'=>'50px','height'=>'50px')).'</a>'; else echo $this->Html->image("/img/prod/no_img.jpg",array('width'=>'50','height'=>'50'));?> </div>
			<div class="col-md-9">
		...
		<div class="form-group">
			...
			<div class="col-md-1"><?php if($this->request->data['Promo']['img_promo_homepage']!=null)  echo '<a class="image-popup-no-margins" href="'.$this->Html->url('/img/prom/'.$this->request->data['Promo']['img_promo_homepage']).'">'.$this->Html->image('prom/'.$this->request->data['Promo']['img_promo_homepage'],array('width'=>'50px','height'=>'50px')).'</a>'; else echo $this->Html->image("/img/prod/no_img.jpg",array('width'=>'50','height'=>'50'));?> </div>
			<div class="col-md-9">
		...
		<div class="form-group">
			...
			<div class="col-md-1"><?php if($this->request->data['Promo']['img_promo_detail']!=null)  echo '<a class="image-popup-no-margins" href="'.$this->Html->url('/img/prom/'.$this->request->data['Promo']['img_promo_detail']).'">'.$this->Html->image('prom/'.$this->request->data['Promo']['img_promo_detail'],array('width'=>'50px','height'=>'50px')).'</a>'; else echo $this->Html->image("/img/prod/no_img.jpg",array('width'=>'50','height'=>'50'));?> </div>
			<div class="col-md-9">
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				<?php echo $this->Form->input('deleted', array('options' => array(1=>'Yes',0=>'No'), 'required'=>'required')); ?>
			</div>
		</div>
		<div class="form-group">
