    ...
    <div class="box-grey-second">
      <div class="row">
		...
		<?php if($data['product_id']=='21'):?>
          <h4 class="title-calculate"><span class="bold"><?php echo rp($premium); CakeSession::write('PremiumJSK', $premium); ?> (berdasarkan usia tertanggung tertua)</span></h4>
		  <?php else:?>
        ...
        <div class="box-grey-second">
          <div class="row">
            ...
            <div class="col-xs-6 col-sm-7 col-md-8 col-lg-8"> 
              ...
              <?php
                  if ($data['QUOTE_PREMIUM_MODE'] == 1) {
                    echo rp($cashlessFee) . " (dibayarkan secara reguler bersamaan dengan premi)";
                  }
                  else {
                    echo rp($cashlessFee * 12) . " (dibayarkan sekali dimuka)";
                  }  
              ?> </span></h4>
            </div>
          </div>
