	...
	<div class="row margintop">
		<div class="col-md-12">
			<div class="clearfix"><h1 class="title-login">
				<span class="bold red">Forgot Password</span>
			</h2>
		</div>
		<hr class="redline">
	</div>
...
<div class="row">
	<div class="col-md-12">
		<h1 class="login-title">
			<span class="bold">Lupa <span class="red bold">Password Anda</span>? silahkan <span class="red bold">Recovery</span></span>
		</h1>
		<p class="text-center">Anda akan mendapatkan informasi reset password setelah Anda memasukan alamat email di bawah ini</p><br /><br />
		<?php echo $this->Session->flash('flash', array('element' => 'failure'));?>

		<?php echo $this->Form->create('User',array('url'=>array('controller'=>'front','action'=>'forgot_password'),'role'=>'form','class'=>'form-horizontal')); ?>

		<div class="form-group">
			<div class="col-sm-offset-4 col-sm-4">
				<input name="data[User][email]" type="email" id="form-field-1" placeholder="Email Member" class="form-control " required="required" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-4 col-sm-4">
				<center><button class="btn-login" type="submit"><i class="icon-key bigger-110"></i>Reset Password</button></center>
			</div>
		</div></form>
	</div>
</div>
