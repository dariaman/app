	...
	<div class="container">
		<div class="hub-say">
			...
			<?php 
				...
				<div class="form-group col-sm-3 hidden-sm hidden-md hidden-lg">
					<a href="/chat_with_us/chat?locale=id" target="_blank" class="hidden-sm hidden-md hidden-lg img-responsive" onClick="ga('send', 'event', { eventCategory: 'communication', eventAction: 'click', eventLabel: 'chat with us - home'}); if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('/chat_with_us/chat?locale=id&amp;url='+escape(document.location.href)+'&amp;referrer='+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=500,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><button  class="btn-caf-yellow" id="liveChat" >Live Chat</button></a>
...
<section >
	<div class="container">
		<div class="hub-say" style="background:white;">
			<?php echo $this->Session->flash('flash', array('element' => 'success'));?>
			<center><h5 style="font-size:42px;color:black;">Saya Mau ?</h5></center>
			<?php 
				echo $this->Form->create('Leavenumber',array('id'=>'Lnumber','class'=>' form-inline','role'=>'form','type' => 'post','novalidate'=>true)); 
				$this->Form->inputDefaults(array('label' => false));
				?>
				...
				<div class="form-group col-sm-2">
					<?php echo $this->Form->input('Contact_Email', array('id'=>'email',  'placeholder' => 'Email', 'class'=>'form-control', 'div'=>false, 'type'=>'text')); ?>
				</div>
				<div class="form-group col-sm-1">
					<button type="submit" class="btn-caf-green" id="leave-numb-btn" onclick="Leave_Number();">Kirim</button>
				</div>
				<div class="form-group col-sm-2">
					<!--<a href="/chat_with_us/chat?locale=id" target="_blank" class="btn-caf-green" onClick="ga('send', 'event', { eventCategory: 'communication', eventAction: 'click', eventLabel: 'chat with us - home'}); if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('/chat_with_us/chat?locale=id&amp;url='+escape(document.location.href)+'&amp;referrer='+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=500,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;">Live Chat</a>-->
<a href="/chat_with_us/chat?locale=id" target="_blank" class="hidden-sm hidden-md hidden-lg" onClick="ga('send', 'event', { eventCategory: 'communication', eventAction: 'click', eventLabel: 'chat with us - home'}); if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('/chat_with_us/chat?locale=id&amp;url='+escape(document.location.href)+'&amp;referrer='+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=500,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><img img src="<?php echo $this->Html->url("/"); ?>img/live-chat-3917.jpg" alt="Live Chat" /></a>
...
<section >
	<div class="container" align="center" >
		<div style="background:trasparent;">
			<h5 style="font-size:42px;">CEK <strong>KEBUTUHAN</strong> ANDA</h5>
			
				<div class="form-group col-sm-3 col-xs-6" >
					<a href="<?php echo $this->Html->url("/");?>product"><img alt="list produk" src="<?php echo $this->Html->url("/");?>img/newicon/produk-02.png" class="img-responsive"></a>
				</div>
				<div class="form-group col-sm-3 col-xs-6">
					<a href="<?php echo $this->Html->url("/");?>preview"><img alt="list rekanan" src="<?php echo $this->Html->url("/");?>img/newicon/rs-rekanan-03.png" class="img-responsive"></a>
				</div>
				<div class="form-group col-sm-3 col-xs-6">
					<a href="<?php echo $this->Html->url("/");?>cara-klaim"><img alt="petunjuk klaim"src="<?php echo $this->Html->url("/");?>img/newicon/klaim-04.png" class="img-responsive"></a>
				</div>
				<div class="form-group col-sm-3 col-xs-6">
					<a href="<?php echo $this->Html->url("/");?>promo"><img alt="promo"src="<?php echo $this->Html->url("/");?>img/newicon/promo-05.png" class="img-responsive"></a>
				</div>
				<div class="clearfix"></div>
...
<!-- init new jagadiri beda -->
<section >
	<div class="container" >
		<div class="services" style="background:white;">

			<div class="col-sm-12" >
					<center><img alt="jagadiri berbeda"src="<?php echo $this->Html->url("/");?>img/newicon/jagadiri-berbeda.png" class="img-responsive"></center>
			</div>
			<div class="vide col-sm-12">
	...
	<div class="container">
		<div class="services">
			...
			<div class="vide col-sm-6">
				<iframe src="//www.youtube.com/embed/exQ_n2vGDDA?rel=0" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
...
<div class="container">
	<h2 class="title text-center" style="background:white;">
			Ada Apa Dengan <span class="peach">JAGADIRI</span>
	</h2>
                	   		...
                	   		<div class="item <?php if($i==0){echo "active";} ?>">
	                                    <div class="col-md-4">
	                                        ...
	                                        if($ns["News"]['picture']==""){
	                                       	...
	                                       	<?php }else{ ?>
	                                       <img alt="Gambar:<?php echo $ns['News']['title'];?>" src="<?php echo $this->Html->url("/");?>img/news/<?php echo $ns['News']['picture'];?>" class="img-responsive " style=" max-height: 6cm;"/>
	                                       	<?php } ?>
...
<div class="modal fade" id="modalnotif" style="padding-top:7%;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="row">
			  <img    src="img/New-Year-2017.jpg" alt="Happy new year 2017">
			</div>
		</div>
	</div>
</div>
		...
		<div class="no-gap clearfix">
					<div class="col-md-12">
						<div class="row">
						    <!-- banner -->
                            <div class="">
				<a href="/promo/hut.htm" >
                                <img class="img-responsive"  src="img/CNY-01.png" alt="Happy new year 2017">
				</a>
                        	</div>
						</div>
                    </div>
