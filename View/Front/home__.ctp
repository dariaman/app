<!-- POPUP FOR PILIH RAWAT INAP /JALAN-->
<div id="pilih-rawat-inap-jalan-modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title"><span class="big">Klik untuk memilih</span></h4>
        </div>
        <div class="modal-body">
            <a href="/rawat-inap-jalan/form"><img src="/img/pilih-rawat-inap-jalan.png" class="img-responsive"></a>
        </div>
    </div>
  </div>
</div>

<!-- POPUP FOR INPUT DATA SESUDAH PILIH RAWAT INAP/JALAN -->
<div id="rawat-inap-jalan-form-modal" class="modal fade" role="dialog">
    <?php echo $this->Form->create(false, array('url' => '/rawat-inap-jalan/form/submit', 'class' => 'form-horizontal')); ?>
    <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><span class="big">Lengkapi form dibawah</span></h4>
          </div>
          <div class="modal-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        if($('a[href="/promo/rawat-inap-dan-rawat-jalan.htm"]').length) {
            $('a[href="/promo/rawat-inap-dan-rawat-jalan.htm"]').click(function(event) {
                event.preventDefault();
                $('#pilih-rawat-inap-jalan-modal').modal('show');
            });
        }

        if($('a[href="/rawat-inap-jalan/form"]').length) {
            $('a[href="/rawat-inap-jalan/form"]').click(function(event) {
                event.preventDefault();
                $('#pilih-rawat-inap-jalan-modal').modal('hide');
                $('#rawat-inap-jalan-form-modal').modal('show');
            });
        }
    });
</script>