<div class="row">
    <div class="col-md-12">
	<center>
	<img src="/img/logo.png" alt="Asuransi Jaga Diri" class="logo img-responsive">
	</center>
    </div>
</div>
<?php echo $this->Session->flash('flash', array('element' => 'good'));?>
		<?php echo $this->Form->create('reservasi_jaber',array('id'=>'formEvent',/*'url'=>array('controller'=>'front','action'=>'reservasi_nonton'),*/'class'=>'form-horizontal','role'=>'form','novalidate'=>true));
...
<?php $options = array('M' => '&nbsp;Laki laki ', 'F' => '&nbsp;Perempuan ');
	  ...
	  <div class="col-sm-10">
		...
		<div ><br/>  <center><button type="submit" class="calculate"  id="calculate-btn" >Kirim</button> <i id="loading" style="display:none;" class="fa fa-refresh fa-spin fa-lg"></i>
					<button  type="button" id="reset-btn">Reset</button> <i id="loading" style="display:none;" class="fa fa-refresh fa-spin fa-lg"></i></center>
		<br/></div> 
<script>
...
$("#reset-btn").click(function(){ 
	...
	$("#reservasi_jaberNAMA").val('');
	$("#tgl_lahir").val('');
	$("#reservasi_jaberGENDERF").prop('checked', false);
	$("#reservasi_jaberGENDERM").prop('checked', false);
	$("#phone").val('');
	$("#reservasi_jaberEMAIL").val('');
	$("#reservasi_jaberADDRESS").val('');
});
...
var valQuote = $("#formEvent").validate({
	...
	focusInvalid:false,
	rules: {
		"data[reservasi_jaber][EMAIL]" :{ required:true, myEmail:true},
		"data[reservasi_jaber][ADDRESS]":{required:true, minlength:10},


	},
	messages: {
		"data[reservasi_jaber][ANSWER]": "Masukan jawaban anda",
		"data[reservasi_jaber][NAMA]": "Masukan nama anda",
		"data[reservasi_jaber][GENDER]": "Pilih jenis kelamin anda",
		"data[reservasi_jaber][TTL]": "Masukan tanggal lahir anda",
		"data[reservasi_jaber][EMAIL]":{required:"Masukan Email Anda",email:"Email anda belum valid"},
		"data[reservasi_jaber][ADDRESS]": {required:"Masukan Alamat Anda",minlength:"Mohon Isi Alamat Lengkap Anda"},
		"data[reservasi_jaber][Contact_Phone]": "Masukan nomor telepon anda",
	},
