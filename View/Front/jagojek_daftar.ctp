<div class="container-fluid" style="margin-top:35px">
	<div class="row">
		<div class="col-md-12">
			<section class="body">
	<img src="/img/gojek/gopoint-big.png" alt="GO-POINTS" class="center">
	<?php
	...
	<?php 
		echo $this->Form->create('RegGojek',array('id'=>'RegGojek','class'=>' form-inline','role'=>'form','type' => 'post','novalidate'=>true)); 
