...
<div class="row">
	...
	<h3 class="title-berita"><?php echo $newsdetail['News']['title'];?></	>
	<div><?php echo $newsdetail['News']['content'];?></div>
			 ...
			 <?php foreach ($news2 as $ns){ ?>
						...
						<div class="col-md-6" style="height:250px">
							...
							<div class="col-md-6">
								 <div class="text"><?php echo $ns["News"]['title'] ?></div>
								<br>
								 <div class="text"><?php echo $ns["News"]['short_desc'] ?></div>
...
<a href="<?php echo $this->Html->url(array('controller'=>'front','action'=>'news'))?>">Load More</a>
