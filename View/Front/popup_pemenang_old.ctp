...
<div id="boxes">
    <div id="dialog" class="window">
        <div id="popupfoot"><img src="<?php echo $this->Html->url('/')?>img/popup_hasil_rawat_inap_jalan/pop_up_pemenang.jpg" width="400px" height="400px"onclick="alert('voucher anda akan dikirim ke alamat rumah dalam waktu 30hari');"/></div>
    </div>
    <div id="mask"></div>
</div>
