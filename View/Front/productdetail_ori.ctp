	...
	<div class="row">
      ...
      <div class="carousel-inner">
		...
		<div class="col-md-8">
           ...
           <ul>
            <li><span class="peach-ondetail">+</span> 1 (satu) perlindungan kesehatan sekaligus untuk keluarga anda dengan</li> 
			<li><span class="peach-ondetail"> </span> harga terjangkau</li>
      ...
      <div class="row margintop3">
          <div class="col-sm-6">
          <?php $gaSend=array(1=>'jsp',2=>'ja',3=>'jj',4=>'cfl',5=>'dbd',6=>'jai',7=>'jh',8=>'jjp5',9=>'jap5',10=>'jap7',11=>'jjp7',12=>'jsk'); // ga code
		$appProd=array('jaga-sehat-plus','jaga-sehat-dbd','jaga-sehat-keluarga','jaga-aman-instan','jaga-aman','jaga-jiwa','jaga-aman-plus5','jaga-aman-plus7','jaga-jiwa-plus5','jaga-jiwa-plus7');?>
      ...
      <?php endif; ?>-->
          ...
          <div class="col-sm-6"><?php if($productdetail['Product']['id']==4 || $productdetail['Product']['id']==5 || $productdetail['Product']['id']==6):?><a href="/chat_with_us/chat?locale=id" target="_blank" onClick="ga('send', 'event', { eventCategory: 'communication', eventAction: 'click', eventLabel: 'chat with us - home'}); if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('/chat_with_us/chat?locale=id&amp;url='+escape(document.location.href)+'&amp;referrer='+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=500,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><button type="button" class="btn2 btn-cont-neww">Tanya CS Kami</button></a><?php else:?><button type="button" class="btn2 btn-cont-neww" <?php if($productdetail['Product']['id']==1):?> onClick="ga('send', 'event', { eventCategory: 'potential lead', eventAction: 'click', eventLabel: 'contact - jsp'});" <?php endif;?> data-toggle="modal" data-target="#modalaw" id="contactme-btn">Bantu Pembelian Saya</button><?php endif;?></div>
                    </div> 
