...
<div>CIMB CLICK</div>
<!--<script src="< echo $this->Html->url("/"); ?>linequiz-assets/js/jquery.js"></script>
...
<div class="widget-box login-front">
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php if ($Status != 1 || (!isset($status['reason_id']) || $status['reason_id'] != 1)) echo "Mohon Maaf"; else echo "Terima Kasih"; ?></li>
            </ol>
    ...
    <div class="row margintop">
        <div class="col-md-12">
            <div class="clearfix"><h1 class="title-login">
                    <span class="bold red">
                        <?php if ($prod != 'PREMIUM PAYMENT'): ?>
                            ...
                            ?>
                            Pembelian Asuransi <?php echo $prod ?> Anda <?php if ($status != '' && isset($data['Status'])) echo $status; else echo "Belum Berhasil"; //echo "Gagal";      ?> 
                        <?php else: ?>
                            Pembayaran Premium Policy <?php echo $status['transactionNo'] ?> Anda <?php if ($status != 'Gagal') echo "Sukses"; else if ($status != '') echo $status; else echo "Belum Berhasil"; //echo "Gagal";      ?> 
                        <?php endif; ?>
                    </span>
                    </h2>
            </div>
            ...
            <?php endif; ?>
            Transaksi Pembayaran Anda <?php
            if (isset($status['transactionNo'])) {
                if ($status['ErrDesc'] == "Customer Cancel Transaction")
