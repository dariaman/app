...
<head>
	...
	<!-- gojek Core CSS -->
	<link href="<?php echo $this->Html->url("/");?>css/gojek/gaya.css" rel="stylesheet">
	<link href="<?php echo $this->Html->url("/");?>css/gojek/bootstrap.min.css" rel="stylesheet">
	<link href="<?php echo $this->Html->url("/");?>css/gojek/bootstrap-datepicker.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<?php echo $this->element('front/header_jagojek'); ?>
