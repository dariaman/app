...
<!-- End of Google Analytics Content Experiment code -->
  ...
  <meta property="og:url" content="https://www.jagadiri.co.id" />
	...
	<link href="<?php echo $this->Html->url("/");?>css/bootstrap-landing.css" rel="stylesheet">
	<link href="<?php echo $this->Html->url("/");?>css/landing1.css" rel="stylesheet">
                      ...
                      <a href="<?php echo $this->Html->url(array('controller'=>'front','action'=>'step1_non_unitlink','id'=>'jaga-aman-instan')); ?>"><button id="btn-apply-product-jai" type="submit" onClick="ga('send', 'event', { eventCategory: 'customer lead-lp', eventAction: 'click', eventLabel: 'beli - jai'});" class="btn-beli">BELI</button></a>
						...
						<div class="row">
								...
								<div class="col-sm-9">
									...
									<div class="row">
										<div class="col-md-7">
											<p>Dapatkan perlindungan dalam hitungan detik saat atau sebelum melakukan aktivitasmu.</p>
											
											<p>Miliki informasi rumah sakit di seluruh Indonesia dan nomor darurat untuk akses penting di saku Anda</p>
										</div>
										<div class="col-md-5">
											<!--<button class="btn-beli">BELI</button>-->
							...
							<div class="col-md-6">
								<div class="box-blue">
									<div style="padding:10px 20px;">
										Mulai JAGADIRI Anda dengan <br />perlindungan instan yang ekonomis
									</div>
									<div class="tri">
							...
							<div class="col-md-6">
								...
								<div style="padding:10px;">
									<ul class="find">
										...
										<li><a href="<?php echo $this->Html->url(array('controller'=>'front','action'=>'home','#'=>'contact'))?>" id="noHashtag">Cara mudah membeli produk <br />JAGADIRI via Web atau Aplikasi</a></li>
